...
export function Navbar() {
  ...
  return (
    ...
    <header className="z-50 bg-cream/95 backdrop-blur-sm border-b-[0.5px] border-navy/10">
      <TopBar />
...
export function NavSpacer() {
  return <div style={{ height: 'var(--header-h, 80px)', transition: 'height 300ms' }} />;
}
