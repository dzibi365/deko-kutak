...
export const t = {
  en: {
    ...
    auth_forgot_sent: "Check your email — we've sent a password reset link.",
  ...
  bs: {
    ...
    auth_forgot_title: "Resetuj lozinku",
    auth_forgot_sub: "Unesite email i poslaćemo vam link za resetovanje.",
    auth_forgot_btn: "Pošalji link",
    auth_forgot_sent: "Provjerite email — poslali smo vam link za resetovanje lozinke.",
    auth_back_signin: "Nazad na prijavu",
    auth_reset_title: "Nova lozinka",
    auth_reset_new: "Nova lozinka",
    auth_reset_confirm: "Potvrdite lozinku",
    auth_reset_btn: "Ažuriraj lozinku",
    auth_reset_mismatch: "Lozinke se ne podudaraju.",
    auth_reset_success: "Lozinka ažurirana! Možete se sada prijaviti.",
